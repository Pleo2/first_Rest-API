...
export class MovieModel {
    ...
    static async create({ input }) {
        ...
        // TODO: Verficar si esto funciona
        // const { rows: checkTitles } = await pg.query('SELECT lower(title) from movie')
        // const toLowerCaseTitle = toLowerCase(title)

        // if (checkTitles.includes(toLowerCaseTitle)) {
        ...
        try {
            ...
            // console.log(e) bad practice el usuario nunca debe ver el error de una request a sql
    ...
    static async update({ id, input }) {
        // TODO crear y verificar en windows
        // const {
        //     genre: genreInput, // genre is an array
        //     title,
        //     year,
